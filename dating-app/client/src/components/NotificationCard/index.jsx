...
const NotificationCard = ({ notification, onRead }) => (
  <button
    ...
    className={`glass-soft flex w-full items-start gap-3 p-4 text-left transition ${
  ...
  >
    ...
    <div className="min-w-0 flex-1">
      <div className="flex items-center justify-between gap-3">
        <h3 className="font-display text-base font-semibold">{notification.title}</h3>
        <Bell size={14} className="text-spark-pink" />
      </div>
