...
const MessagesPage = () => {
  ...
  return (
    <div className="grid gap-5 lg:grid-cols-[320px_minmax(0,1fr)]">
      <div className="glass-panel max-h-[720px] overflow-hidden p-5">
        <SectionHeader title="Conversations" subtitle="Realtime chat with your matches." />
        <div className="spark-scrollbar max-h-[620px] space-y-3 overflow-y-auto pr-1">
          {conversations.length ? (
            ...
            <div className="glass-soft p-8 text-center text-white/60">
              Your matches will appear here once a conversation starts.
            </div>
          )}
        </div>
      </div>
